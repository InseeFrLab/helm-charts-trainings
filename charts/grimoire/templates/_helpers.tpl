...
helm.sh/chart: {{ include "grimoire.chart" . }}
{{ include "grimoire.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "grimoire.selectorLabels" -}}
...
*/}}
{{- define "grimoire.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "grimoire.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "grimoire.configMapNameS3" -}}
{{- if .Values.s3.create }}
{{- $name:= (printf "%s-configmaps3" (include "grimoire.fullname" .) )  }}
...
*/}}
{{- define "grimoire.configMapNameVault" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapvault" (include "grimoire.fullname" .) )  }}
...
*/}}
{{- define "grimoire.configMapNameGit" -}}
{{- if .Values.vault.create }}
{{- $name:= (printf "%s-configmapgit" (include "grimoire.fullname" .) )  }}
